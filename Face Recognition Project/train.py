...
class Train:
    def __init__(self,root):
        ...
        img_top=Image.open(r"D:\Face Recognition Project\images\facialrecognition.png")
        ...
        img_bottom=Image.open(r"D:\Face Recognition Project\images\photos.jpg")
        img_bottom=img_bottom.resize((1300,280),Image.Resampling.LANCZOS)
